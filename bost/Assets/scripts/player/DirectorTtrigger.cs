...
using UnityEngine.Playables;
    ...
    　　public enum triggercond
           {collid,intract,talk,continues,Attack }
    ...
    void Update()
    {
        if (triggercondtion == triggercond.Attack && m_AlreadyTriggered)
        ...
        void OnTriggerEnter2D(Collider2D other)
    {
        ...
        else if(triggercondtion == triggercond.Attack){
            Damager damageable = other.GetComponent<Damager>();
