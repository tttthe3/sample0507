...
public class Playerinput : MonoBehaviour
{
    ...
    public InputButoon Skill3 = new InputButoon(KeyCode.T, PS4ControllerButton.L2); //すきるまる
    ...
    public void SetPause(InputButoon button)
    {
        Pause = button;
    }

    public void SetAttack(InputButoon button)
    {
        Attack = button;
    }
    public void SetJump(InputButoon button)
    {
        Jump = button;
    }

    public void SetDash(InputButoon button)
    {
        Dash = button;
    }

    public void SetPowerAttack(InputButoon button)
    {
        PowerAttack = button;
    }
    public void SetSkill(InputButoon button)
    {
        Skill = button;
    }
    public void SetSkill2(InputButoon button)
    {
        Skill2 = button;
    }
    public void SetSkill3(InputButoon button)
    {
        Skill3 = button;
    }

    public void SetIntract(InputButoon button)
    {
       Intract = button;
    }
    ...
    void Update()
    {
        ...
        Skill3.InputCheck(m_fixedupdate || Mathf.Approximately(Time.timeScale, 0), inputType);
...

    {
        ...
        ReleaseControllerButton(Skill3, resetvalue);
